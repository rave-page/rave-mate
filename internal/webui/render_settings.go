	...
	case "medialink":
		...
		return i18n.T("settings.card.medialink.title"), i18n.T("settings.card.medialink.desc"),
			fpair(selectBoxTip(i18n.T("settings.body.medialink.codec"), "set:ml-codec", [][2]string{{"", "auto"}, {"hevc", "hevc"}, {"h264", "h264"}, {"mjpeg", "mjpeg"}}, mf.PreferCodec, "ml-accel"),
				...
				fpair(selectBoxTip(i18n.T("settings.body.medialink.maxFps"), "set:ml-maxfps", [][2]string{{"30", "30"}, {"60", "60"}, {"-1", i18n.T("settings.body.medialink.uncapped")}}, strconv.Itoa(fpsCapSel(mf.MaxFPS)), "ml-fps"),
					selectBoxTip(i18n.T("settings.body.medialink.maxHeight"), "set:ml-maxheight", [][2]string{{"0", i18n.T("settings.body.medialink.auto")}, {"720", "720p"}, {"1080", "1080p"}, {"1440", "1440p"}, {"-1", i18n.T("settings.body.medialink.native")}}, strconv.Itoa(mf.MaxHeight), "ml-height")) +
