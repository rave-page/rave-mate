...
const (
	...
	// Mixxx - mixxxdb.sqlite set-log poll: DB-poll, master-only, delayed (no per-deck data).
	SourceMixxx = "mixxx"
)
...
var fieldPriority = map[string][]string{
	FieldTitle:     {SourceQML, SourceTraktor, SourceSeratoRemote, SourceVDJNetCtl, SourceRekordboxMem, SourceSerato, SourceMIDIDenon, SourceProDJLink, SourceRekordboxDB, SourceVDJHistory, SourceMixxx, SourceNML, SourceSeratoLive, SourceIcecast, SourceNowPlaying},
	FieldArtist:    {SourceQML, SourceTraktor, SourceSeratoRemote, SourceVDJNetCtl, SourceRekordboxMem, SourceSerato, SourceMIDIDenon, SourceProDJLink, SourceRekordboxDB, SourceVDJHistory, SourceMixxx, SourceNML, SourceSeratoLive, SourceIcecast, SourceNowPlaying},
	FieldAlbum:     {SourceNML, SourceQML, SourceTraktor, SourceSerato, SourceRekordboxDB, SourceMixxx},
	FieldGenre:     {SourceNML, SourceQML, SourceTraktor, SourceSerato, SourceRekordboxDB, SourceMixxx},
	FieldKey:       {SourceQML, SourceTraktor, SourceVDJNetCtl, SourceRekordboxMem, SourceSerato, SourceProDJLink, SourceRekordboxDB, SourceMixxx, SourceNML, SourceMIDICustom},
	FieldBPM:       {SourceQML, SourceTraktor, SourceSeratoRemote, SourceVDJNetCtl, SourceVDJOS2L, SourceRekordboxMem, SourceProDJLink, SourceSerato, SourceMIDICustom, SourceRekordboxDB, SourceMixxx, SourceNML},
	FieldIsPlaying: {SourceQML, SourceTraktor, SourceSeratoRemote, SourceVDJNetCtl, SourceRekordboxMem, SourceProDJLink, SourceMIDIFeedback, SourceMIDICustom, SourceSerato, SourceSeratoLive, SourceMixxx},
...
var defaultPriority = []string{SourceQML, SourceTraktor, SourceSeratoRemote, SourceVDJNetCtl, SourceRekordboxMem, SourceProDJLink, SourceMIDICustom, SourceVDJOS2L, SourceSerato, SourceMIDIDenon, SourceRekordboxDB, SourceVDJHistory, SourceMixxx, SourceNML, SourceSeratoLive, SourceIcecast, SourceNowPlaying}
