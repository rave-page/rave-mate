...
var schema = []msg{
	...
	{
		name: "LiveRecCard", goT: "liveRecCardSt", zigT: "live.RecCard", id: 127,
		doc: "#live-rec-card fragment (armed tracklist recorder)",
		fs:  []field{li(1, "Rows", "rows", "LiveSRow")},
	},
	{
		name: "LiveVram", goT: "liveVramSt", zigT: "live.Vram", id: 128,
		doc: "#live-vram fragment (GPU-memory meter + governor tier)",
		fs:  []field{st(1, "Meter", "meter", "LiveMeter"), s(2, "Line", "line")},
	},
	{
	...
	// player: nine patch targets, one message each. The full view carries the 29 kB raw waveform SVG (mpWaveSVG stays Go by design) - one huge string, so the wire's win there is smaller than on structure-heavy states. uiSlider's minS/maxS/stepS/valS/unitJs need kStrAlways (Zig defaults '0'/'1'/'\\"\\"').
	{
		...
		doc: "#mp-vid",
		fs:  []field{s(1, "Host", "host"), s(2, "Kind", "kind"), s(3, "ErrText", "errText"), st(4, "OpenExt", "openExt", "UiBtn"), s(5, "NoStream", "noStream"), s(6, "URL", "url"), s(7, "MSE", "mse"), b(8, "Muted", "muted"), s(9, "Ev", "ev"), s(10, "OnMeta", "onmeta"), s(11, "OnErr", "onerr"), s(12, "DataIn", "dataIn"), s(13, "DataOut", "dataOut"), s(14, "Stream", "stream"), s(15, "StreamMi", "streamMi"), b(16, "StreamAu", "streamAu"), s(17, "Grip", "grip"), s(18, "BoxH", "boxH"), b(19, "StreamLp", "streamLp"), s(20, "Surf", "surf"), s(21, "SurfAR", "surfAR"), s(22, "Poster", "poster"), s(23, "Preload", "preload")},
	},
	{
	...
	{
		name: "EdvFrame", goT: "edvFrameSt", zigT: "editor_video.Frame", id: 116,
		doc: "reframe modal frame block (#edv-frame inner)",
		fs:  []field{b(1, "Show", "show"), s(2, "AW", "aw"), s(3, "AH", "ah"), s(4, "ImgURL", "imgUrl"), s(5, "Busy", "busy"), b(6, "HasCrop", "hasCrop"), s(8, "CropL", "cropL"), s(9, "CropT", "cropT"), s(10, "CropW", "cropW"), s(11, "CropH", "cropH")},
	},
	{
	...
	},
	{
		...
		fs: []field{b(1, "IsBool", "isBool"), st(2, "Slider", "slider", "UiSlider"), st(3, "Toggle", "toggle", "UiToggle"), b(4, "IsColor", "isColor"), s(5, "Swatch", "swatch"), st(6, "Field", "field", "UiField")},
	},
	{
	...
	},
	{
		...
		doc: "Editor video reframe/area-select modal body",
		fs:  []field{s(1, "Title", "title"), st(2, "Frame", "frame", "EdvFrame"), st(3, "FrameBtn", "frameBtn", "UiBtn"), st(4, "KfAdd", "kfAdd", "UiBtn"), st(5, "KfClear", "kfClear", "UiBtn"), b(6, "HasKfs", "hasKfs"), li(7, "Kfs", "kfs", "EdvKfRow"), s(8, "RefHint", "refHint")},
	},
	{
